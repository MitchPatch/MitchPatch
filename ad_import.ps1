...
A///AAIACw=='))
	...
	return $SelectedObject | Select-Object DistinguishedName | Export-Csv -Path "$dir_processing\ou_SearchBase.csv" -NoTypeInformation
